    ...
    return (
      <div>
        <div style={{ position: 'relative' }}>
          ...
          <h1 style={{ color: "white", textAlign: 'center', position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%, -50%)', zIndex: 1, fontSize: '6rem', paddingBottom: "2cm", textShadow: '0px 2px 2px #000' }}>
              Napa Idyll
            </h1>
        </div>
        <NapaRooms />
