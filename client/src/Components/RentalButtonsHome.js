...
const RentalButtonsHome = () => {
  return (
    ...
    <div style={{ width: "45%", padding: "1rem", fontSize: "larger" }}>Riverfront Idyll in Napa Valley
      <img
    ...
    <div style={{ width: "45%", padding: "1rem", fontSize: "larger" }}>Alpine Idyll at Lake Tahoe
      <img
