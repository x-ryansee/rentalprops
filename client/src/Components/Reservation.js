...
//         console.error(error);
//         if (error.response.status === 422) {
//           window.alert("There was a problem with your reservation. Please try again.");
//         }
//       }
//   };
...
//         </div>
//         <div className="form-field">
//           <label htmlFor="adult-guests">Adult Guests:</label>
//           <input
//             type="number"
//             id="adult-guests"
//             value={adult_guests}
...
//         </div>
//         <div className="form-field">
//           <label htmlFor="child-guests">Child Guests:</label>
//           <input
//             type="number"
//             id="child-guests"
//             value={child_guests}
